...
// Retreive featured post from the database

$featured_query = "SELECT * FROM posts WHERE is_featured=1";
$featured_result = mysqli_query($connection, $featured_query);
$featured = mysqli_fetch_assoc($featured_result);

// Retreive 6 posts from the database
    ...
    <section class="featured">
        <div class="container featured__container">
            ...
            <div class="post__info">
                <?php
                // Retreive category from categories by category post id
                ...
                <p class="post__body"><?= substr($featured['body'], 0, 400) ?>...</p>

                <div class="post__author">
                    <?php
                    // Retreive using id from users table
