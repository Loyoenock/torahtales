...
<section class="featured">
    <div class="container featured__container">
        ...
        <div class="post__info">
            <a href="category-post.php" class="category__button">Jewish Traditions and Rituals</a>
            <h2 class="post__title"><a href="post.php">The Significance of Hanukkah: A Festival of Lights</a></h2>
            <p class="post__body">Hanukkah, also known as the Festival of Lights, commemorates the rededication of the
                Holy Temple in Jerusalem and the miracle of the oil that lasted for eight days. This celebration holds
                deep spiritual significance, reminding us to bring light into our lives and stand against oppression. As
                families light the menorah, spin the dreidel, and enjoy traditional foods, they honor the resilient
                spirit of the Hebrew people throughout history.</p>

            <div class="post__author">
                <div class="post__author-avatar">
                    <img src="/images/avatar2.jpg">
                </div>
                <div class="posSarah Cohent__author-info">
                    <h5>By: Sarah Cohen</h5>
                    <small>June 29, 23</small>
                </div>
            </div>
        </div>
    </div>
